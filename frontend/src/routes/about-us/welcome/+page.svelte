...
<main>
  <div class="relative flex min-h-201 desktop:h-322 flex-col items-center bg-black desktop:py-29.5 py-12 text-white">
    ...
    <p class="text-left tablet:text-center px-[calc(10vw)] text-[16px] desktop:text-[20px] font-normal leading-[29px] desktop:leading-[40px]">
      ...
      서강대학교 유일의 중앙 컴퓨터 동아리입니다.<br>
      SGCC는 컴퓨터에 관한 모든 주제에 대해 환영하는 소통의 장으로서,<br>
      약 40년 간의 역사를 이어가고 있습니다.<br>
      <br>
      SGCC는 컴퓨터에 대한 다양한 분야를 체험할 수 있으며,<br class="desktop:block hidden">
      초심자에게 매우 친화적인 플랫폼입니다.<br class="desktop:block hidden">
      부원들은 매학기 SGCC에서 운영하는 기초 프로그래밍 스터디 및<br class="desktop:block hidden">
      심화 세미나를 통해 함께 학습하며 성장해 나갈 수 있습니다.<br class="desktop:block hidden">
      뿐만 아니라, 슬기로운 인디 생활 등 정기적으로 프로젝트를 진행하며<br class="desktop:block hidden">
      협업의 장으로서 활발하게 활동하고 있습니다.
    </p>
