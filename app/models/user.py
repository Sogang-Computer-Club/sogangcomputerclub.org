...
users = sqlalchemy.Table(
    ...
    sqlalchemy.Column("is_active", sqlalchemy.Boolean, nullable=False, default=True, server_default="1"),
    sqlalchemy.Column("is_admin", sqlalchemy.Boolean, nullable=False, default=False, server_default="0"),
